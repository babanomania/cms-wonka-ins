===========================================================
    ...
    |_| |_| |_|\__,_|\__, |_| |_|\___/|_|_|\__,_|
        ...
        24. May 2016
        v 5.5 (Snapshot: 2016.05.24 09:27:30)
        Community Edition
...
This package contains:
   ...
   Magnolia Core 5.5-SNAPSHOT
   Magnolia Internationalization Framework 5.5-SNAPSHOT
   Magnolia Imaging Support Module 3.3-SNAPSHOT
   Magnolia JAAS 5.5-SNAPSHOT
   Magnolia Imaging Module 3.3-SNAPSHOT
   Magnolia Rendering 5.5-SNAPSHOT
   Magnolia Templating 5.5-SNAPSHOT
   Magnolia Templating for JSP 5.5-SNAPSHOT
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.5-SNAPSHOT.html
